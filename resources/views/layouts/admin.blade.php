      ...
      <nav class="navbar-default navbar-static-side" role="navigation">
         <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
               ...
               <li>
                  <a href="{{route('profile/edit')}}"><i class="fa fa-user"></i> <span class="nav-label">Profile</span></a>
               </li>
               <li>
                  <a href="{{route('contact/edit')}}"><i class="fa fa-bank"></i> <span class="nav-label">Contact</span></a>
               </li>
               <li>
                  <a href="{{route('article/index')}}"><i class="fa fa-newspaper-o"></i> <span class="nav-label">Article</span></a>
               </li>
               <li>
                  <a href="{{route('gallery/index')}}"><i class="fa fa-image"></i> <span class="nav-label">Gallery</span></a>
               </li>
               <li>
                  <a href="#"><i class="fa fa-handshake-o"></i> <span class="nav-label">Service</span> <span class="fa arrow"></span></a>
                  <ul class="nav nav-second-level collapse">
                     <li><a href="{{ route('service/index') }}">Service</a></li>
                     <li><a href="{{ route('subService/index') }}">Sub Service</a></li>
                     <li><a href="{{ route('detailService/index') }}">Detail Service</a></li>
                  </ul>
               </li>
            </ul>
         </div>
      ...
      <div id="page-wrapper" class="gray-bg">
         ...
         <div class="footer">
            <div class="pull-right">
               Powered by <strong><a href="#">lazyCode</a></strong>
            </div>
            <div>
               <strong>Copyright</strong> Yosef Almeida Boy &copy; 2018
            </div>
         </div>
      </div>
   </div>
